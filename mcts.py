...
if __name__ == "__main__":
    ...
    parser.add_argument('--num_sims', action="store", default=5, type=int)
    parser.add_argument('--levels', action="store", default=5, type=int, choices=range(State.NUM_TURNS + 1))
